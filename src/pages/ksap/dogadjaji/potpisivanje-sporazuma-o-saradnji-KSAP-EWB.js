...
export const PAGE_QUERY = graphql`
  {
    gallery: allFile(
      filter: {
        relativeDirectory: {
          eq: "gallery/potpisivanje-sporazuma-o-saradnji-KSAP-EWB"
        }
      }
    ) {
      edges {
    ...
    conference: contentfulHappening(
      id: { eq: "3b77d6be-82b1-59db-a537-318271183a6d" }
    ) {
      content {
        json
      }
...
const PotpisivanjeSporazumaKSAPEWB = ({ data }) => {
  ...
  return (
    <Layout>
      <SEO title="Potpisivanje sporazuma o saradnji KSAP-EWB" />
      <Hero img={childImageSharp.fluid} alt={name} hero={true}>
        <Banner>Potpisivanje sporazuma o saradnji KSAP-EWB</Banner>
      </Hero>
...
export default PotpisivanjeSporazumaKSAPEWB;
